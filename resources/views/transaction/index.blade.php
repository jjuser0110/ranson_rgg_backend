        ...
        <div class="modal-content ">
            ...
            <div class="modal-body pd-20">
                <div class="form-group">
                    ...
                    <label class="form-label" for="exampleInputEmail1">Player ID</label>
                    <input type="text" class="form-control" name="player_id" id="player_id"  placeholder="Enter Player ID">
